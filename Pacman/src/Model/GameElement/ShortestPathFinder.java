...
public class ShortestPathFinder extends PathFinder {
    ...
    public ShortestPathFinder(PathingTarget target, Collection<Node> nodes, Collection<Path> paths) {
        super(target);
    ...
    public double getBestDistance(Guider guider){
        ...
        return distance.get(bestPath.getNodes().get(bestPath.getNodes().size()-1));
    }
